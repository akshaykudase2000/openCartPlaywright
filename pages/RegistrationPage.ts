...
export class RegistrationPage {
    ...
    */
    ...
    async setTelephone(tphone: string): Promise<void> {
        await this.txtTelephone.fill(tphone);
    }
   ...
   */
    ...
    async setConfirmPassword(cpass: string): Promise<void> {
        await this.txtConfirmPassword.fill(cpass);
    }
